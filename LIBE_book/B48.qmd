...
gg<-plot_fit("/home/garofalo/analysis/data_LIBE_gm2/out/LIBE_B48.dat_fit_dmu_phys",var = "Mpi2_m_Mpiiso2",gg=gg, width = 0.0008)
fig<-myplotly(gg,"","$(aM_\\pi)^2-(aM_\\pi^{iso})^2$","$a\\delta_\\mu$", to_print = TRUE)
```